...
const NuevaVenta = () => {
  ...
  const agregarListaVenta = (e) => {
    ...
    setListaVenta([...listaVenta, { ...productoSeleccionado, cantidad: cantidad }]);
    setCantidad('');
  };
          ...
          <table className='red-border'>
            <tbody>
              ...
              <tr>
                ...
                <th className='th-venta red-border text-center'>Valor Unitario</th>
              ...
              {listaVenta.map((producto) => (
                <tr key={producto._id}>
                  ...
                  <td className='red-border'>
                    {producto.valorUnitario ? formatoMoneda(producto.valorUnitario) : ''}
                  </td>
                  <td className='red-border'>{producto.cantidad}</td>
                  <td className='red-border'>
                    {producto.valorUnitario * producto.cantidad !== 0
                      ? formatoMoneda(producto.valorUnitario * producto.cantidad)
                      : ''}
                  </td>
                </tr>
              ))}
